...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_HELIX_SCHEDUTIL)
...
extern struct cpufreq_governorcpufreq_energy_dcfc;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_energy_dcfc)
